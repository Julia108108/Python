...
print(math.ceil((b / a))) # math.ceil(x) - округление до ближайшего большого числа


# Решение № 2 маржовый оператор позволяет запросить значение. 
...
# Решение № 4 f-строки - интерполяция, т.е. соединение значений в строке
